...
//                 </div>
//
//                 {/* Video — constrained to a readable max width so it doesn't stretch too wide */}
//                 <div className="mx-auto max-w-3xl w-full aspect-video rounded-2xl overflow-hidden border border-[var(--border)] bg-[var(--bg-card)] shadow-sm">
//                     <video
